...
public class PetStoreController {
	...
	public PetStoreData createPetStore(@RequestBody PetStoreData petStoreData) {
		log.info("Received request to create a new pet store with data: {}", petStoreData);
	...
	public PetStoreEmployee addEmployee(@PathVariable Long petStoreId, @RequestBody PetStoreEmployee employee) {
		log.info("Adding employee {} for Pet Store wtih ID={}", employee, petStoreId);
	...
	public PetStoreCustomer addCustomer(@PathVariable Long petStoreId, @RequestBody PetStoreCustomer customer) {
		log.info("Adding customer {} for Pet Store wtih ID={}", customer, petStoreId);
